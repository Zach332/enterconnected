...
export default function ActivityAvailabilityCard( {activityAvailability} ) {
    ...
    return (
        <div
            className={"mx-auto list-group-item list-group-item-action m-1 rounded border bg-info" + (activityAvailability.happening && " border-success")}
            style={{width: 280, height:290}}
        >
            <div style={{width: 250, height: 270}} className={"card list-group-item-action bg-info" + (activityAvailability.happening && " border-success")}>
